...
insert into user (user_id, user_pw, user_name, user_email, user_phone, user_birth, user_gender, user_img, user_level, user_grade, user_date)
...
values ('user-1', 'H1', '010-1234-1234', '안녕하세요 H1 입니다', 'user1@itwill.com', 'defaulthostPro.png', '1234-12-123456', '해빗은행', '호스트1', '2022-01-05 00:00:00');

insert into host (host_id, host_name, host_phone, host_intro, host_email, host_img, host_account, host_bank, host_acholder, host_date)
values ('user-2', 'H2', '031-123-1234', '안녕하세요 H2 입니다', 'user2@gmail.com', 'host2.jpg', '1234-12-123457', '해빗은행', '호스트2', '2022-04-06 00:00:00');
