                                ...
                                ,success:function(data){
                                    ...
                                    $(data).each(function(){
                                        ...
                                        if(this.refn_status=="RO"){
                                            ...
                                            htmlAppend${status.index}+="          <div>"+this.op_name+"</div>";
                                            htmlAppend${status.index}+="          <div> 구매수량 : "+this.payd_qty+"</div>";
                                            htmlAppend${status.index}+="     </div>";
                                            htmlAppend${status.index}+="  <div class='Home_change_con'>";
                                            htmlAppend${status.index}+="    <div>";
                                            htmlAppend${status.index}+="        <button class='Home_change_btn'>환불하기</button>";
                                            htmlAppend${status.index}+="    </div>";
                                            htmlAppend${status.index}+="    <div>";
                                            ...
                                            htmlAppend${status.index}+="    </div>";
                                            htmlAppend${status.index}+="    <div>";
                                            htmlAppend${status.index}+="        <button class='Home_change_btn'>리뷰쓰기</button>";
                                            htmlAppend${status.index}+="    </div>";
                                            htmlAppend${status.index}+="  </div>";
                                            htmlAppend${status.index}+="</div>";
